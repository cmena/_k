...
class leftctrl(key):
    """acts like a ctrl key.  if pressed solo emit a C-g."""
    ...
    def _keyxcape(self, event):
        # the `key` was xcaped.  that is, another key was pressed while this
        # key was held down (see _k/kmod). this will be interpreted as
        # CTRL+event.code
